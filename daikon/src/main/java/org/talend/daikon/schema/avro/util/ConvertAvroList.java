...
public class ConvertAvroList<DatumT, AvroT> implements HasNestedAvroConverter<List<DatumT>, List<AvroT>> {
    ...
    public List<DatumT> convertToDatum(List<AvroT> value) {
        return Collections.unmodifiableList(
                new MappedList<AvroT, DatumT>(value, new LambdaConvertToDatumFunction<AvroT, DatumT>(elementConverter),
                        new LambdaConvertToAvroFunction<DatumT, AvroT>(elementConverter)));
    }
